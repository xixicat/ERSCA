...
P = [82082, 82021, 81930, 81825, 81650, 80405, 79126, 77748, 76038, 73562, 70811, 68070, 64555, 62835, 60020, 57797, 55300, 47857, 45960, 42890, 40378, 37961, 36067, 34471];
P = P./max(P);
year = 1:length(P);
...
ylabel('Growth rates')
text(5,0.2, sprintf('$y(t)=\\frac{%.2f}{1+e^{%.2ft+%.2f}}$',beta(1), beta(2), beta(3)), 'Interpreter','latex', 'FontSize',30)
legend('原始数据', '拟合曲线');
axis([0 inf 0 inf])
